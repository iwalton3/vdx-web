 ...
 *
 * Usage:
 *   node tools/bundler-esm.js --entry ./lib/framework.js --output ./dist/framework.js
 *   node tools/bundler-esm.js -e ./lib/framework.js -o ./dist/framework.js
 *
 * Options:
...
Default mode (no arguments):
  Generates minified bundles in dist/ with source maps:
...
function bundleAll(verbose) {
    ...
    const frameworkEntry = 'lib/framework.js';
