...
import { reactive, createEffect, trackMutations, flushEffects, runAsEffect, computed, withoutTracking, isReactive, nextRender } from './reactivity.js';
    ...
    class Component extends HTMLElement {
        ...
        async whenMounted(selectorOrElement) {
            ...
            while (true) {
                ...
                if (!el) {
                    const r = await Promise.race([this.nextRender(), unmounted]);
