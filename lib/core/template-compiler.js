...
function buildOpTree(node) {
    ...
    if (node.type === 'element') {
        ...
        // Attribute semantics must not depend on whether defineComponent() has
        // run yet - a template compiled before registration would otherwise be
        // frozen as native forever. The hyphen rule is what buildStaticDOM uses
        // and what the spec requires of a custom element name.
