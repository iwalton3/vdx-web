...
/**
 * localStorage key prefix used by localStore()/darkTheme. The default is a
 * historical artifact kept for persisted-data compatibility; apps sharing an
 * origin should claim their own prefix at startup, BEFORE creating stores:
 *
 *     setLocalStorePrefix('myapp');
 */
let LOCALSTORAGE_PREFIX = 'swapi';
