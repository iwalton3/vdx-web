...
import '../../ui/example-components.js';

// Import shell component
import '../../ui/layout/shell.js';

// Editable, runnable source panels
import '../../ui/misc/code-runner.js';

import { componentExamples } from '../../ui/examples.js';
...
export class ComponentShowcase extends Component {
    ...
    exampleFiles(comp) {
        ...
        if (stripped.startsWith('<')) {
            return { 'index.html': page(source, "import 'vdx/ui/all.js';") };
        }
        let preamble =
        ...
        return html`
            <cl-shell
                ...
                <div slot="topbar" class="topbar-controls">
                    ...
                    <a class="topbar-link" href="/site/tutorial.html">Tutorial ↗</a>
                    <a class="topbar-link" href="/site/tutorial/playground.html">Playground ↗</a>
